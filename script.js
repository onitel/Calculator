class Calculator {
    ...
    addOperation(operation) {
        ...
        if(this.firstLineNumber === '' && operation === '√' || this.firstLineNumber === '-' && operation === '√') {
            this.addNumber('√');
        };
        ...
        if(this.firstLineNumber === '-√') return ;
        if(this.firstLineNumber.toString().includes('√') && operation === '√') return ;
        if(operation === '√') {
    ...
    getNormalNumber(number) {
        ...
        if(radical.includes('√')) {
            integerDisplay = radical + integerDisplay;
        }
